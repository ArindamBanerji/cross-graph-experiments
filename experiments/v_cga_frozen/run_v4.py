...
Run:
    PYTHONUTF8=1 python experiments/v_cga_frozen/run_v4.py
"""
...
def main():
    print("=" * 65)
    print("V-CGA-FROZEN v4 (Empirical Bayes bootstrap — GAE 0.7.3)")
    print("=" * 65)
    ...
    results = {
        "experiment":  "V-CGA-FROZEN-v4",
        "version":     "v4_empirical_bayes_bootstrap",
        "date":        "2026-03-23",
        "n_seeds":     N_SEEDS,
        "verdict":     verdict,
    ...
    print()
    print("=" * 65)
    print(f"V-CGA-FROZEN v4 (Empirical Bayes bootstrap): {verdict}")
    print("=" * 65)
