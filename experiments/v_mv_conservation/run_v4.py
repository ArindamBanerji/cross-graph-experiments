"""
V-MV-CONSERVATION v4 — self-calibrating h OLSMonitor (GAE 0.7.13).
...
Save: experiments/v_mv_conservation/results/results_v4.json
"""
...
def main():
    import gae
    assert gae.__version__ == "0.7.13", f"Need GAE 0.7.13, got {gae.__version__}"
    print(f"V-MV-CONSERVATION v4 (GAE {gae.__version__})")
    ...
    # ---------------------------------------------------------------------------
    out = {
        "experiment":           "V-MV-CONSERVATION-v4",
        "gae_version":          "0.7.13",
        "n_cells":              48,
        "n_seeds":              N_SEEDS,
        ...
        "best_detector": best,
        "vs_v3": {
            "ols_precision_v3": 0.487,
            "ols_precision_v4": ols_mac_p,
            "improvement_pp":   round((ols_mac_p - 0.487) * 100, 1),
        },
        "cells": cell_records,
    }
    ...
    # ---------------------------------------------------------------------------
    print()
    print(f"V-MV-CONSERVATION v4 (48 cells, 20 seeds, GAE 0.7.13):")
    ...
    print(f"  OLSMonitor (self-calibrating h):")
    ...
    print(f"  vs v3: OLS precision 0.487 → {ols_mac_p:.3f} "
          f"({(ols_mac_p - 0.487)*100:+.1f}pp)")
